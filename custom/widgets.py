...
from .utils import CustomColor, CustomFont, CustomOthers

class BaseWidget:
    def __init__(self, foreground=CustomColor.white, background=CustomColor.white):
...
class CustomTemperature(BaseWidget):
    ...
    def __init__(self, foreground=CustomColor.white, background=CustomColor.dark_orange):
...
class CustomColumns(BaseWidget):
    def __init__(self, foreground=CustomColor.white, background=CustomColor.dark_red):
        super().__init__(foreground, background)
